    ...
    function createMap(){
        ...
        var point = new BMap.Point(119.319442,26.073529);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"全球医院网",content:"福州五一中路大利嘉城A区D座5层",point:"119.31972|26.073545",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
		 ];
    //创建marker
    function addMarker(){
