...
function ArticleLibrary() {
		...
		$("#dataTable").grid({
			...
			field : [
			            ...
			            { data: 'description',render:function(value){return value.substr(0,60)+'...';}},
			            {
						  ...
						  render : function(id, type, row){
							  var str = '';
				              str += '<a style="text-decoration:none" onClick="gArticleLibrary.FopenEditWID(\'预览文章\',\'../shortcuts/article-preview.html?id='+id+'\',\'920\',\'460\');" href="javascript:;" title="预览"><i class="Hui-iconfont">&#xe695;</i></a>';
	...
	this.signleDownload = function(id){
		...
		self.cmd(gHttp, {controller:'Library',method:'search_download',id:id}, function(result) {
			switch( result.statu ){
				case true:
					$('#search_download_'+id).html('<i class="Hui-iconfont ml-5" title="下载成功" style="color:#5eb95e;">&#xe615;</i>');
					break;
				case false:
					$('#search_download_'+id).html('<i class="Hui-iconfont ml-5" title="下载失败" style="color:#f37b1d;">&#xe6dd;</i>');
					break;
		    }
		});
	}
