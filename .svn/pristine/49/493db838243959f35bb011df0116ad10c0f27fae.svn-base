 ...
 *
 */
class EnvironmentTag extends CommonTag {
	...
	public function getPageHtml($current, $size = '',$show_position) {
		...
		#.生成html信息
		return $this->setPageHtml($current, $size , $count , 'environment' );
	}
	...
	public function get($value) {
		...
		$environment->generateFromRedBean($result);
		return $environment;
	}
    /**
     * 
     * 获取列表 
     */
    public function getEnvList($sql){
