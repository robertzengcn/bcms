...
class MediaReportTag extends CommonTag {
	...
	public function getPageHtml($current, $size = '',$show_position) {
		...
		#.生成html信息
		return $this->setPageHtml($current, $size , $count , 'media' );
	}
	 ...
	 */
	public function getByRecommend($recommend,$name='media_id',$is_tomobile=''){
     ...
     * 获取列表 
     */
    public function getMedList($sql){
