...
class ContactService extends BaseService {
     ...
     * @param $val: val
     * */
    public function updateflag($flag,$val){
    	$contact=$this->dao->getContact($flag);
    ...
    * */
    ...
    public function getsmtpusername(){
    	return $result=$this->dao->getsmtpusername();
    }
    ...
    public function getsmtppass(){
    	return $result=$this->dao->getsmtppass();
    }
    ...
    * */
    public function getsmtpport(){
    	return $result=$this->dao->getsmtpport();
    }
    ...
    public function getsmtphost(){
    	return $result=$this->dao->getsmtphost();
    }
